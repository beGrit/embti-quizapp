import 'package:emombti/ui/knowledge/widgets/knowledge_contents_book_detail.dart';
    ...
    bookData = [
      {
        ...
        'image': 'https://embti-storage-dev.grit-soft.com/contents/565806.jpg',
        'isAsset': false,
        'url': 'https://item.jd.com/12591872.html',
      },
      {
        'title': 'The Archetypes and the Collective Unconscious',
        'image': 'https://embti-storage-dev.grit-soft.com/contents/67890.jpg',
        'isAsset': false,
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => KnowledgeContentsBookDetailScreen(
              imageUrl: imageUrl,
              title: title,
              url: url,
              isAsset: isAsset,
