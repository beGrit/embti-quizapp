...
class LocalStorageFacade implements LocalStorage {
  ...
  @override
  Future<List<ArticleContent>> getArticleContents() => sqlite.getArticleContents();

  @override
  Future<ArticleContent?> getArticleContentById(String id) => sqlite.getArticleContentById(id);

  @override
  Future<List<VideoContent>> getVideoContents() => sqlite.getVideoContents();

  @override
  Future<List<KnowledgeContent>> getKnowledgeContents() => sqlite.getKnowledgeContents();
  ...
  @override
  Future<List<AssessmentResult>> getAssessmentResults() => sqlite.getAssessmentResults();
  ...
  @override
  Future<List<SurveyFlow>> getFlows({String? surveyId}) => sqlite.getFlows(surveyId: surveyId);
  ...
  @override
  Future<List<AssessmentResult>> getAllAssessmentResults() => sqlite.getAllAssessmentResults();

  @override
  Future<AssessmentResult?> getAssessmentResult(String surveyFlowId) => sqlite.getAssessmentResult(surveyFlowId);

  @override
  Future<void> clearAssessmentHistory() => sqlite.clearAssessmentHistory();

  @override
  Future<void> saveSubmission(AssessmentResult result) => sqlite.saveSubmission(result);
}
